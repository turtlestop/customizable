...
<div id="editf">
<img class="icon" src="images/editmb.png" height="42" width="42" onmouseover="this.src='images/editmb2.png'" onmouseout="this.src='images/editmb.png'" onclick="location.href='http://localhost:8888/login.php'">
</div>
